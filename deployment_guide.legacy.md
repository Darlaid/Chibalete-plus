# 🗄️ ARCHIVADO — Guía de Despliegue Legacy (PM2-first)

> 🔴 **AVISO IMPORTANTE — DOCUMENTO ARCHIVADO**
>
> Esta guía describe la fase **PM2-first previa al hardening Docker** de Chibalete+.
>
> **NO representa la producción actual.** Producción corre como Docker
> Compose con containers `chibalete_edge`, `chibalete_front`,
> `chibalete_api_1`, `chibalete_api_2`. PM2 ya **NO gobierna producción**.
>
> **Si llegaste aquí buscando cómo desplegar:** detente. Lee
> [`deployment_guide.md`](./deployment_guide.md), que es la **fuente
> canónica operacional vigente**.
>
> Este documento se conserva únicamente como **referencia histórica** del
> stack previo (PM2 + nginx host + `/var/www/chibalete/dist`). Cualquier
> instrucción aquí escrita está desactualizada y aplicarla romperá la
> separación operativa actual.
>
> **Contexto histórico:**
> - Fase: instalación inicial sobre Hostinger VPS antes de containerizar.
> - Topología que describe: nginx system + PM2 + node directo en
>   `/var/www/chibalete/`.
> - Reemplazada por: docker-compose en `/opt/chibaleteplus/` con
>   bind mounts vivos.
